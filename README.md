...
An end-to-end data engineering and analytics project that processes 2.2M+ Google Play Store records to uncover market trends and generate actionable insights.
The system integrates Generative AI (Llama 3.3 via Groq) to automatically transform structured data into human-readable narratives and real-time “market intelligence” summaries.
...
Due to large size (2.2M+ records), dataset is not included in the repo.
